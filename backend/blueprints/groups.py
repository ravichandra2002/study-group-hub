...
# @jwt_required()
# def list_groups():
#     """Return groups I belong to, including pendingCount for owners."""
#     try:
#         db = get_db()
...
#         out = []
#         for d in rows:
#             is_owner = str(d.get("ownerId")) == uid_str
#             out.append(
#                 {
#                     "_id": str(d["_id"]),
#                     "title": d.get("title", ""),
...
# def browse_groups():
#     """
#     Return ONLY public info for open groups.
...
#                     status = "member"
#                 elif any((r.get("userId") == _uid) and r.get("status") == "pending"
#                          for r in d.get("joinRequests", [])):
#                     status = "requested"
...
#         my_in_requests = any(
#             (r.get("userId") == uid) and r.get("status") == "pending"
#             for r in doc.get("joinRequests", [])
#         )
...
#         # already pending?
#         if any(
#             (r.get("userId") == user["_id"]) and r.get("status") == "pending"
